        ...
        <section id="combos" className="py-32 bg-white relative overflow-hidden">
            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    ...
                    <div className="group relative glass-card p-12 transition-all duration-500 hover:-translate-y-2 hover-glow rounded-[2.5rem] reveal-up [animation-delay:200ms]">
                        <div className="relative z-10">
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-3 text-[11px] font-black uppercase tracking-[0.15em] text-amber-900 transition-all hover:gap-5"
                            >
                                Solicitar Protocolo
                    ...
                    <div className="group relative glass-card p-12 transition-all duration-500 hover:-translate-y-2 hover-glow rounded-[2.5rem] reveal-up [animation-delay:400ms]">
                        <div className="relative z-10">
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-3 text-[11px] font-black uppercase tracking-[0.15em] text-pink-900 transition-all hover:gap-5"
                            >
                                Solicitar Protocolo
                                <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                            </a>
                    ...
                    <div className="lg:col-span-1 group relative overflow-hidden rounded-[2.5rem] bg-gray-900 p-12 transition-all duration-500 shadow-premium hover:shadow-2xl reveal-up [animation-delay:600ms]">
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            ...
                            <a
                                href="#recommender"
                                className="inline-flex items-center justify-center gap-3 w-full py-5 text-[11px] font-bold text-white uppercase tracking-[0.2em] transition-all bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl hover:bg-white/20"
                            >
                                Iniciar Consulta IA
