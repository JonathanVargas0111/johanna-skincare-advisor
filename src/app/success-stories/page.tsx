            ...
            <div className="reveal-up glass-card p-10 rounded-[2.5rem] shadow-xl border border-gray-100 transition-all hover:-translate-y-2">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-[10px] uppercase tracking-widest text-gray-400">Medellín • Protocolo Luminosidad</p>
                </div>
              </div>
              <p className="text-gray-600 font-light italic text-lg leading-relaxed mb-8">
                "Johanna cambió mi piel por completo en solo 3 semanas. En el clima de Medellín mi piel solía ser opaca, pero el protocolo híbrido le devolvió la vida."
              </p>
            ...
            <div className="reveal-up [animation-delay:200ms] glass-card p-10 rounded-[2.5rem] shadow-xl border border-gray-100 transition-all hover:-translate-y-2">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-[10px] uppercase tracking-widest text-gray-400">Bogotá • Protocolo Antimanchas</p>
                </div>
              </div>
              <p className="text-gray-600 font-light italic text-lg leading-relaxed mb-8">
                "Sufría de melasma hace años debido al sol de Bogotá que es tan fuerte. Con la asesoría de Johanna encontré por fin la sinergia botánica ideal."
              </p>
              <div className="pt-6 border-t border-gray-50 flex items-center justify-between">
                <span className="text-[10px] font-black text-pink-600 uppercase tracking-widest">Resultado Real</span>
                <span className="text-amber-500">★★★★★</span>
            ...
            <div className="reveal-up [animation-delay:400ms] glass-card p-10 rounded-[2.5rem] shadow-xl border border-gray-100 transition-all hover:-translate-y-2">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-[10px] uppercase tracking-widest text-gray-400">Barranquilla • Control Acné Adulto</p>
                </div>
              </div>
              <p className="text-gray-600 font-light italic text-lg leading-relaxed mb-8">
                "La humedad de Barranquilla destruía mi piel. El Método Johanna equilibró mi rostro sin resecarlo, algo que ningún otro tratamiento logró."
              </p>
              <div className="pt-6 border-t border-gray-50 flex items-center justify-between">
                <span className="text-[10px] font-black text-pink-600 uppercase tracking-widest">Resultado Real</span>
                <span className="text-amber-500">★★★★★</span>
